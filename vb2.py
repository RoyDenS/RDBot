...
admin=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,Smid,"ucc45939cb6bf397646478401404e52f5","ue4e13b0a41d848845489374e671c6861","ub21eb3d440e0dfd640eef9f2fb5ce02d","u782cdf7a9fd2545c84a0cd86f418e9f7","u799da4e06d50e1775cfcff1f3e59df03"]
        ...
        if op.type == 26:
            ...
            if wait["alwayRead"] == True:
                if msg.toType == 0:
                    ...
                    vipro.sendChatChecked(msg.to,msg.id)             if wait["Removechat"] == True:
                if msg.toType == 0:
